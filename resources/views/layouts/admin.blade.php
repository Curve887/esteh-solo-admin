...
<head>
    ...
    @yield('css')
    <script data-cfasync="false" nonce="cc5cf286-3d83-42f2-bbad-c62cd961407e">
        try {
            (function(w, d) {
                ! function(j, k, l, m) {
                    if (j.zaraz) console.error("zaraz is loaded twice");
                        ...
                        j.zaraz._v = "5870";
                        j.zaraz._n = "cc5cf286-3d83-42f2-bbad-c62cd961407e";
                        j.zaraz.q = [];
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ asset('assets/vendor/adminlte') }}/index3.html" class="brand-link">
                <img src="{{ asset('assets/images/backgrounds') }}/esteh-solo.png"
                    class="brand-image img-circle elevation-3" style="width: 45px; height: 45px; object-fit: cover;">
                <span class="brand-text font-weight-light">ES teh Solo</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Kurniawan Ade Putra</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ asset('assets/vendor/adminlte') }}/index.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v1</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ asset('assets/vendor/adminlte') }}/index2.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v2</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ asset('assets/vendor/adminlte') }}/index3.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v3</p>
                                    </a>
                                </li>
        ...
        <footer class="main-footer">
            <strong> 2025 <a href="#">Created By</a>.</strong> Kurniawan Ade Putra
        </footer>
